...
def calculate_camarilla_pivot_points(data: pd.DataFrame, date: date, period: int) -> List[float]:
...
def calculate_camarilla_pivot_points_all(data: pd.DataFrame, date: date, period: int) -> List[List[float]]:
